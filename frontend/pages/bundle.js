...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "body {\n    background: #000;\n    color: #CCC;\n}\n\n#example3 span {\n    display: block;\n    width: 100%;\n    background: #CCC;\n    color: #000;\n    border: 1px solid #FFF;\n}\n\n.spanText {\n    padding: 5px;\n}\n.parentDiv {\n    margin-left: 15px;\n    font-size: 14pt;\n}\n\n.tableauComponent {\n    float: left;\n    display: inline-block;\n    margin: 15px;\n    width: 10%;\n    min-width: 220px;\n    height: auto;\n    min-height: 180px;\n    border-radius: 10px;\n    border-right: 4px solid #666;\n    border-bottom: 4px solid #666;\n    border-top: 2px solid #FFF;\n    border-left: 2px solid #FFF;\n    padding: 10px;\n}\n.tableauComponent .title {\n    font-size: 14pt;\n}\n.tableauComponent .description {\n    font-size: 10pt;\n}\n.tableauComponent .tableauRow {\n    width: 100%;\n    clear: both;\n    display: block;\n    margin: 5px 0;\n}\n.tableauComponent .tableauRow .indicator {\n    float: left;\n    display: inline;\n    width: 15px;\n    height: 15px;\n    border-radius: 10px;\n    background-color: #CCC;\n    border: 1px solid #000;\n}\n.tableauComponent .tableauRow .indicator.green {\n    background-color: green;\n}\n.tableauComponent .tableauRow .indicator.yellow {\n    background-color: yellow;\n}\n.tableauComponent .tableauRow .indicator.red {\n    background-color: red;\n}\n.tableauComponent .tableauRow .rowText {\n    float: left;\n    margin-left: 20px;\n    width: auto;\n}", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dataService = __webpack_require__(147);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var createFragment = __webpack_require__(131);
	...
	var ComponentContainer = function (_React$Component) {
	  (0, _inherits3.default)(ComponentContainer, _React$Component);
	
	  function ComponentContainer(props) {
	    (0, _classCallCheck3.default)(this, ComponentContainer);
	
	    var _this = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(ComponentContainer).call(this, props));
	
	    _this.state = { componentList: [] };
	    return _this;
	  }
	
	  (0, _createClass3.default)(ComponentContainer, [{
	    ...
	    value: function render() {
	      return React.createElement(
	        ...
	        React.createElement(
	          'div',
	          { className: 'row' },
	          React.createElement(Repeater, { componentList: this.state.componentList })
	        )
	      );
	    }
	  }, {
	...
	var ComponentCount = function (_React$Component2) {
	  (0, _inherits3.default)(ComponentCount, _React$Component2);
	
	  function ComponentCount() {
	    (0, _classCallCheck3.default)(this, ComponentCount);
	    return (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(ComponentCount).apply(this, arguments));
	  }
	
	  (0, _createClass3.default)(ComponentCount, [{
	    key: 'render',
	    value: function render() {
	...
	var CurrentTime = function (_React$Component3) {
	  (0, _inherits3.default)(CurrentTime, _React$Component3);
	
	  function CurrentTime() {
	    (0, _classCallCheck3.default)(this, CurrentTime);
	    return (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(CurrentTime).apply(this, arguments));
	  }
	...
	var ComponentOptions = function (_React$Component4) {
	  (0, _inherits3.default)(ComponentOptions, _React$Component4);
	
	  function ComponentOptions(props) {
	    (0, _classCallCheck3.default)(this, ComponentOptions);
	
	    var _this4 = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(ComponentOptions).call(this, props));
	
	    _this4.update = _this4.update.bind(_this4);
	    return _this4;
	  }
	
	  (0, _createClass3.default)(ComponentOptions, [{
	    key: 'render',
	    value: function render() {
	      return React.createElement(
	        'div',
	...
	var RepeaterRow = function (_React$Component5) {
	  (0, _inherits3.default)(RepeaterRow, _React$Component5);
	
	  function RepeaterRow(props) {
	    (0, _classCallCheck3.default)(this, RepeaterRow);
	    return (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(RepeaterRow).call(this, props));
	  }
	
	  (0, _createClass3.default)(RepeaterRow, [{
	    key: 'render',
	    value: function render() {
	...
	var cleanNum = function cleanNum(numStr) {
	  var num = (numStr + '').replace('%');
	  return parseInt(num);
	};
	
	var establishIndicator = function establishIndicator(val, arrayArg) {
	  var thresholdArray = arrayArg;
	  var indicator = '';
	
	  var determineAsc = function determineAsc(val, thresholdArray) {
	    var indicator = '';
	  ...
	  var determineDesc = function determineDesc(val, thresholdArray) {
	    var indicator = '';
	    if (val <= cleanNum(thresholdArray[0]) && val > cleanNum(thresholdArray[1])) {
	      indicator += ' green';
	    }
	...
	var FieldRepeater = function (_React$Component6) {
	  (0, _inherits3.default)(FieldRepeater, _React$Component6);
	
	  function FieldRepeater() {
	    (0, _classCallCheck3.default)(this, FieldRepeater);
	    return (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(FieldRepeater).apply(this, arguments));
	  }
	
	  (0, _createClass3.default)(FieldRepeater, [{
	    key: 'render',
	    value: function render() {
	...
	var Repeater = function (_React$Component7) {
	  (0, _inherits3.default)(Repeater, _React$Component7);
	
	  function Repeater(props) {
	    (0, _classCallCheck3.default)(this, Repeater);
	    return (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(Repeater).call(this, props));
	  }
	  ...
	  (0, _createClass3.default)(Repeater, [{
	    ...
	    value: function tick() {
	      ...
	      var updateComponentData = function updateComponentData() {
	        ...
	        var processNext = function processNext(cb) {
	          ...
	          i++;
	          var name = row.name;
	          (0, _dataService.getApi)(url, name).then(function (data) {
	        ...
	        var finalCb = function finalCb(bVal) {
	    ...
	    value: function render() {
	      ...
	      for (var i = 0; i < componentListTemp.length; i++) {
	        ...
	        rows.push(React.createElement(RepeaterRow, { key: i, index: i, componentList: componentListTemp }));
	      }
	      return React.createElement(
	        'div',
	        null,
	...
	ReactDOM.render(React.createElement(ComponentContainer, null), document.getElementById('ComponentContainer'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(45)(IteratorPrototype, __webpack_require__(85)('iterator'), function(){ return this; });
	...
	module.exports = {
	  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
	    function(test, buggy, set){
	      try {
	        set = __webpack_require__(43)(Function.call, __webpack_require__(103).f(Object.prototype, '__proto__').set, 2);
	        set(test, []);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(132).create;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactElement = __webpack_require__(138);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getApi = exports.getApi = function getApi(route, param, optionalThis, optionalParam) {
	...
	var DataFetchInterface = exports.DataFetchInterface = function () {
	  function DataFetchInterface() {
	    (0, _classCallCheck3.default)(this, DataFetchInterface);
	
	    this.componentList = this.componentList || [];
	  }
	
	  (0, _createClass3.default)(DataFetchInterface, [{
	    ...
	    key: 'fetchComponentList',
	    value: function fetchComponentList() {
	      var that = this;
	      return new _promise2.default(function (resolve, reject) {
