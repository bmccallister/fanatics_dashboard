...
/***/ function(module, exports, __webpack_require__) {
	...
	var createFragment = __webpack_require__(94);
	var tbApi = __webpack_require__(110);
	var componentData = [];
	...
	var dataObject = {
	  ...
	  fetchComponentList: function fetchComponentList() {
	    var that = this;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getApi = function getApi(route, param, optionalThis, optionalParam) {
	    return new _promise2.default(function (resolve, reject) {
	        param = param || '';
	        var url = route;
	        if (param.length > 1) {
